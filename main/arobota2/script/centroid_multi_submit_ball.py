...
class assign_centroid():
    ...
    def findpos(self):
        if self.ready:
            ...
            d1 = np.array([(-0.6)*math.cos(math.pi/6),(-0.6)*math.sin(math.pi/6),0])  
            d2 = np.array([0,0.6,0])
            d3 = np.array([0.6*math.cos(math.pi/6),-0.6*math.sin(math.pi/6),0])
            ...
            q_robot3 = Quaternion(0,0,0.9659258,0.258819)
            q_robot2 = Quaternion(0,0,0.7071068,-0.7071068)
            q_robot1 = Quaternion(0,0,0.258819,0.9659258)
