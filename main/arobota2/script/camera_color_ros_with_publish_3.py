...
class color_shape_detection:
    ...
    def __init__(self):
        rospy.init_node('camera_shape_color_cv_3',anonymous=True)
        ...
        self.pubopencvimg = rospy.Publisher('/robot3/opencv/image/compressed', CompressedImage, queue_size=10 )
        self.pubopencvmask = rospy.Publisher('/robot3/opencv/mask/compressed', CompressedImage, queue_size=10 )
        ...
        self.alpha = 30    #Camera field of view in the horisontal plane [degrees] for robot3
