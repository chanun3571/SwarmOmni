...
class create_visual_sphere():
    ...
    def send_ball_pose(self):
        self.ball_pose.position.x = self.depth*cos(self.robotangle)
        self.ball_pose.position.x = self.depth*sin(self.robotangle)
        self.ball_pose.orientation = self.robotquat
